...
export default function AboutUs({ isEn = false }) {
  const text = {
    pt: {
      ...
      whoWeAreBody:
        "Somos uma agência de marketing digital que revolucionou a forma como empresas escalam seus negócios online. Atuamos em 4 continentes sendo eles América, Europa, Ásia e Oceania, entregando campanhas de alto impacto com foco em resultados reais. Unimos mídia paga, branding e marketing estratégico.",
      missionTitle: "Nossa Missão",
      missionBody:
        "Transformar pequenas empresas em grandes marcas através de estratégias digitais que geram resultados mensuráveis e crescimento sustentável.",
      ...
      features: [
        {
          ...
          description:
            "Analisamos mais de 30 métricas diferentes para otimizar suas campanhas",
        },
        {
          icon: Megaphone,
          title: "Anúncios com alta retenção",
          description:
            "Design que converte com taxas de engajamento superiores a 60%",
        },
        {
          icon: Users,
    ...
    en: {
      ...
      whoWeAreBody:
        "We’re a global social media agency reshaping how companies scale online. We operate across four continents: America, Europe, Asia, and Oceania, delivering high-impact campaigns built around real results. Our work blends branding, content strategy, and smart funnel architecture to attract the ideal customers to your business.",
      missionTitle: "Our Mission",
      missionBody:
        "To help every company we partner with reach the highest level in its industry through strategies that deliver measurable results and continuous, sustainable growth.",
      ...
      features: [
        {
          ...
          description:
            "We make your brand seen, remembered, and followed every single day.",
        },
        {
          icon: Check,
          title: "Ongoing branding improvement and reports",
          description:
            "Monthly report with results, strategy analysis, and adjustments with your team when needed.",
        },
        {
          icon: Check,
          title: "Follow-up on your top competitors",
          description:
            "We analyze the strategies of the leading players in your industry worldwide to position your brand one step ahead.",
        },
        {
          icon: Check,
          title: "Content that creates real connection",
          description:
            "Posts crafted with attention to every detail to go viral and attract your ideal target audience.",
        },
      ],
  ...
  return (
    <section id="sobre" className="py-20 px-4 sm:px-8 lg:px-16 bg-black">
      <div className="max-w-7xl mx-auto">
        ...
        >
          <motion.div className="space-y-8 grid" variants={itemVariants}>
            <motion.h3
            ...
            >
              <h4 className="text-xl font-semibold text-white mb-4">
                {currentText.missionTitle}
              </h4>
              <p className="text-gray-300">{currentText.missionBody}</p>
            </motion.div>
                ...
                <div className="flex items-center gap-3">
                  <div className="w-6 h-6 relative">
                    <Image
                      ...
                      src="/google-remove-bg.png"
                      fill
                    />
                  </div>
                  <span className="text-white font-medium">
                    {currentText.partnerGoogle}
                  </span>
                </div>
                <div className="flex items-center gap-3">
                  <div className="w-6 h-6 relative">
                    <Image
                      ...
                      src="/MetaADS.png"
                      fill
                      // MUDANÇA para objectFit: "contain"
                      style={{ objectFit: "contain" }}
                    />
                  </div>
                  <span className="text-white font-medium">
                    {currentText.partnerMeta}
                  </span>
                </div>
              </div>
            </motion.div>
              ...
              <div className="grid grid-cols-2 gap-4 text-sm">
                <div>
                  ...
                  <div className="text-gray-400">
                    {currentText.resultsConversionRate}
                  </div>
                </div>
                <div>
                  <div className="text-2xl font-bold text-[#c28a32]">50%</div>
                  <div className="text-gray-400">
                    {currentText.resultsCostReduction}
                  </div>
                </div>
              </div>
            </motion.div>
