  ...
  return (
    <section className="relative min-h-screen flex items-center justify-center px-4 sm:px-8 lg:px-16 pt-16">
      ...
      <div className="absolute inset-0 overflow-hidden">
        <motion.div
          className="absolute top-20 left-10 w-72 h-72 bg-[#FF8C00]/10 rounded-full blur-3xl"
          animate={{
            scale: [1, 1.2, 1],
            opacity: [0.3, 0.6, 0.3],
          }}
      ...
      <div className="max-w-7xl mx-auto w-full relative z-10">
        ...
        >
          ...
          <motion.div className="flex-1 space-y-8" variants={itemVariants}>
            ...
            >
              <div className="text-center">
                <motion.div
                  className="text-3xl font-bold text-[#FF8C00]"
                  initial={{ scale: 0 }}
                  animate={{ scale: 1 }}
            ...
            {/* CTA Button */}
            <motion.button
              className="btn-primary bg-[#FF8C00] hover:bg-[#FFA500] text-white font-semibold py-4 px-8 rounded-lg text-lg transition-all duration-300 relative overflow-hidden group"
              variants={itemVariants}
              whileHover={{
                scale: 1.05,
            ...
            >
              ...
              <motion.div
                className="absolute inset-0 bg-gradient-to-r from-[#FFA500] to-[#FF8C00]"
                initial={{ x: "-100%" }}
                whileHover={{ x: "0%" }}
          ...
          >
            ...
            >
              <div className="absolute inset-0 bg-gradient-to-r from-[#FF8C00]/20 to-[#FFD700]/20 opacity-50" />
