...
export default function Testimonials({ isEn = false }) {
  ...
  const text = {
    pt: {
      ...
      ctaText:
        "Você pode ter esses resultados também, basta agendar uma consulta sem compromisso abaixo",
    ...
    en: {
      ...
      subTitle:
        "See what our clients have to say about the results they achieved with Lion Media. Real stories of transformation and growth.",
      ctaText:
        "You can get results like this too. Claim your free, no-obligation consultation below.",
